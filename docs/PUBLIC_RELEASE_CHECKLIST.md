...
`v0.2.0` is a controlled public release for Codex-first toolkit use. It is not a Level 4, Level 5, enterprise-certified, production-certified, broad package-distribution, automatic tool-installation, or non-Codex runtime-support claim.
...
- [ ] GitHub release notes state the controlled Codex toolkit posture, validation evidence, known exclusions, rollback path, and no Codex OSS application submission.
