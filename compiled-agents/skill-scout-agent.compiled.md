...
- Inherited sourceRef IDs: `addy-osmani-agent-skills`, `anthropic-skills`, `code-review-graph`, `everything-claude-code`, `gitlab-agent-skills`, `ruflo`, `superpowers`, `toolkit-authored`, `unknown-review-required`
