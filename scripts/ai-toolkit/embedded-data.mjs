...
export const TOOL_ENTRIES = [
  ...
  ["code-review-graph", "code-review-graph", "tirth8205/code-review-graph", "https://code-review-graph.com", "source-intelligence", "local-first code intelligence graph for MCP/CLI and large-repo context mapping", "active-read-only", "active-read-only source intelligence; no install, indexing, MCP/global config, CI wiring, package changes, product repo scanning, or evidence claims without approved output"],
