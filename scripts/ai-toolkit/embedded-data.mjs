...
export const TOOL_ENTRIES = [
  ...
  ["react-doctor", "React Doctor", "react-doctor/react-doctor", null, "react-scanner", "React codebase scanning for correctness, performance, architecture, accessibility, and AI-generated React risks", "source-review-required", "conditional, non-blocking first if project-local script exists"],
  ...
  ["reviewdog", "reviewdog", "reviewdog/reviewdog", "https://reviewdog.github.io", "pr-feedback", "deterministic scanner-output PR reporter", "conditional", "avoid noise and duplication with CodeRabbit"],
  ["coderabbit", "CodeRabbit", "coderabbitai/coderabbit-docs", "https://www.coderabbit.ai", "pr-review", "contextual AI PR review", "delegated-existing", "existing or delegated; do not duplicate"],
