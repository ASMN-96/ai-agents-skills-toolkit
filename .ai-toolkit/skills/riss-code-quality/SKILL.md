...
description: Compatibility alias for code-quality. Use code-quality for new prompts, docs, profiles, routing, and evals; keep this old RISS alias only for existing prompt and project compatibility.
---
