...
description: Compatibility alias for governance. Use governance for new prompts, docs, profiles, routing, and evals; keep this old RISS alias only for existing prompt and project compatibility.
---
