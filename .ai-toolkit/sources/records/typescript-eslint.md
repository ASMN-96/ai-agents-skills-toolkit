# typescript-eslint Source Record

- Source name: typescript-eslint
- Repository: typescript-eslint/typescript-eslint
- Source URL: https://github.com/typescript-eslint/typescript-eslint
- Homepage: https://typescript-eslint.io
- Purpose: typed linting for TypeScript and JavaScript
- Category: linting
- License status: unknown-review-required
- Maintenance signal: not-yet-verified
- Useful patterns: baseline if configured
...
- Recommended toolkit status: baseline-script-if-configured
