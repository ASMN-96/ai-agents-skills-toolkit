# OpenSSF Scorecard Source Record

- Source name: OpenSSF Scorecard
- Repository: ossf/scorecard
- Source URL: https://github.com/ossf/scorecard
- Homepage: https://scorecard.dev
- Purpose: third-party repo security posture and source trust signal
- Category: source-trust
- License status: unknown-review-required
- Maintenance signal: not-yet-verified
- Useful patterns: source-safety review only
...
- Recommended toolkit status: source-only
