...
- Purpose: container, filesystem, IaC, SBOM, vulnerability, secrets, and license scanning
- Category: container-iac-security
- License status: unknown-review-required
- Maintenance signal: not-yet-verified
- Useful patterns: only if Docker, IaC, or container assets exist
