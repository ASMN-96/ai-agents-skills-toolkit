...
| --- | --- | --- | --- | --- | --- |
| skills | `skills/<skill>/SKILL.md` | .agents/skills/<skill>/SKILL.md for the five active runtime skills only | .ai-toolkit/skills/<skill>/SKILL.md for packaged active skills | None in this pass unless a file is explicitly marked historical | byte identity between canonical, runtime, and distribution copies |
...
| profiles | `profiles/*.md` | none | .ai-toolkit/profiles/*.md | older profile notes only if marked | manifest hashes and registry reference validation |
